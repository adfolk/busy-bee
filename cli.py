...
def Get_Tags(
    ...
    all_tag_types: Annotated[bool, typer.Option("--all", "-a", help="By default, only TODOs are show. Use this flag to show all tag types")] = False
    ):
    created_project = fill_app_tables(project_path)
    table = make_display_table(created_project.name)
    row_num = 0

    # TODO: figure out how to make this neater.
